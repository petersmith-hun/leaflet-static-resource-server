...
import {header, Headers, HttpStatus, ResponseWrapper} from "../../../../src/lsrs/web/model/common";
import {FileIdentifier, FileModel} from "../../../../src/lsrs/web/model/files";
import {ParameterizedMappingHelper, ParameterlessMappingHelper} from "../../../../src/lsrs/web/utility/mapping-helper";
import {uploadedFile1} from "../../core/dao/uploaded-file-dao.testdata";
import {fileBuffer} from "../../core/service/service.testdata";
import {fileModel1} from "../web.testdata";
